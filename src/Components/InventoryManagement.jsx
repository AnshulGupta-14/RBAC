...
const InventoryManagement = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-r from-red-400 to-red-300 rounded-lg shadow-md">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            <button
              ...
              className="absolute top-4 right-4 rounded-xl p-2 bg-red-500 text-white hover:scale-110"
            >
              Close
            </button>
