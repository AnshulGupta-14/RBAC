      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {filteredHospitals.map((hospital) => (
          ...
          >
            ...
            <p>
              <strong>Location:</strong> {hospital.address.city}
            </p>
            <p>
              <strong>Contact:</strong> {hospital.email}
            </p>
            <div className="mt-4">
              <button
      ...
      {isDetailsModalOpen && selectedHospital && (
        ...
        >
          ...
          >
            ...
            <p>
              <strong>Name:</strong> {selectedHospital.hospitalName}
            </p>
            <p>
              <strong>Location:</strong> {selectedHospital.address.city}
            </p>
            <p>
