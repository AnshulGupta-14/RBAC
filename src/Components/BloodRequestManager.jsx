  ...
  const viewBloodRequests = () => {
    const dummyData = [
      ...
      },
      {
        ...
        bloodType: "O-",
        status: "Approved",
        additionalInfo: "Scheduled for tomorrow",
      },
      {
        id: 3,
        ...
        bloodType: "B+",
        status: "Rejected",
        additionalInfo: "Not enough stock",
      },
      {
        id: 4,
        requester: "Greenfield Clinic",
        type: "Hospital",
        bloodType: "AB+",
        status: "Pending",
        additionalInfo: "Type O needed",
      },
      {
        id: 5,
        ...
        bloodType: "A-",
        status: "Approved",
        additionalInfo: "Emergency case",
      },
      {
        id: 6,
        requester: "Red Cross Hospital",
        type: "Hospital",
        bloodType: "O+",
        status: "Pending",
        additionalInfo: "Critical case",
      },
    ];
      ...
      {selectedRequest && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg p-6 w-80 shadow-lg">
            ...
            <p>
              <strong>Additional Info:</strong> {selectedRequest.additionalInfo}
            </p>
            <button
